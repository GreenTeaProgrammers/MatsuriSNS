...
func (pc *PostCreate) SetLocationX(f float64) *PostCreate {
	pc.mutation.SetLocationX(f)
	return pc
}

// SetLocationY sets the "location_y" field.
func (pc *PostCreate) SetLocationY(f float64) *PostCreate {
	pc.mutation.SetLocationY(f)
	return pc
}
...
func (pc *PostCreate) check() error {
	...
	if _, ok := pc.mutation.LocationX(); !ok {
		return &ValidationError{Name: "location_x", err: errors.New(`ent: missing required field "Post.location_x"`)}
	}
...
func (pc *PostCreate) createSpec() (*Post, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.LocationY(); ok {
